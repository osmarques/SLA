...
namespace SLA.Domain.Infra.Extensions.Relational.PostgreSql
{
    public static class DataExtensionPostgres
    {
        #region
        ...
        #region Methods
        public static string PostgreSQLSelect(this DataModel model)
        {
        ...
        public static string PostgreSQLSelect(this DataModel model, IDataFilterCollection filter)
        {
            // Iniciar o processo de montagem do SQL
            string Sintaxe = string.Empty;
        ...
        public static string PostgreSQLCount(this DataModel model)
        {
        ...
        public static string PostgreSQLInsert(DataModel model, bool ReturningKey)
        {
            // Iniciar o processo de montagem da Sintaxe
            string Sintaxe = string.Empty;
        ...
        public static string PostgreSQLUpdate(DataModel model, IDataFilterCollection? Filter = null)
        {
            // Iniciar o processo de montagem da Sintaxe
            string Sintaxe = string.Empty;
        ...
        public static string PostgreSQLDelete(DataModel model, IDataFilterCollection? Filter = null)
        {
            // Iniciar o processo de montagem da Sintaxe
            string Sintaxe = string.Empty;
