...
using SLA.Infra.MongoDBNoSQL.Connector;
...
namespace SLA.AppTest
{
    public static class MongoDBTest
    {
        public static async Task TestAsync() 
        {
            ...
            DBConnectionModel? conn = Connections.Where(r => r.Type == ConnectorEnum.MongoDB).FirstOrDefault();

            Console.WriteLine("= >> Criando connector                                  =");
            IConnector connector = new MongoDBConnector(conn.Connection);
